# Influencers de viajes: la lista, el presupuesto y lo que se les pide

Escrito el 23 de septiembre de 2026, contestando al dueño: *«Quiero obtener un listado de
20-40 influencers relacionados con viajes, de 10.000 a 40.000 seguidores. ¿Cómo lo ves?
¿Presupuesto aprox. que habría que gastar en ellos? ¿Qué contenido deberíamos pedirles
...
Tres cosas que la casa ya sabe y que el encargo no puede saltarse:

- **Primera persona, alguien enseñando lo que ha probado.** Un reel que parece un anuncio
  se salta (`AGENTS.md`). Por eso no se les da un guion: se les da **el formato y lo que
  no puede faltar**, y lo cuentan con su voz.
- **El gancho es el tour a pie, no el itinerario** (`MERCADO-2026-08-15.md`, §Implicaciones
  2): un vídeo siguiendo la voz por la calle enseña lo que nadie más hace; una captura de un
  itinerario enseña lo que ChatGPT regala.
- **Lo que se guarda es el plan** (el reel del demo, 6-sep: 1.258 espectadores y **cero
  guardados**; «un demo de producto no se guarda; un plan de viaje sí»). El plan va en el
  vídeo como lo que el espectador se lleva; la app es quien lo ha escrito.

### Seis formatos, uno por creador según su nicho
...
| **El tour absurdo** (G6) | Cualquiera con humor | «Le pedí un tour de vermuts por Madrid. Me lo hizo.» El que más papeletas tiene de compartirse |
...
A los de canje se les pide menos: el reel **o** las tres historias, lo que prefieran.

### Lo que no puede faltar

- **La app de verdad en pantalla**, nunca una maqueta: es la regla de las capturas.
- **El precio como lo dice la casa**: «**desde 2,99 € el viaje, sin suscripción**». Nunca
...
- **Nada construido sobre una fiesta o un acto con hora.** La app puso mal la hora de los
  cinco actos de la Mercè (issue #6). Un vídeo sobre algo con fecha de caducidad es una
  promesa que la app puede no cumplir delante de miles de personas; los monumentos, las
  calles y los museos no se mueven.
- Que lean un texto nuestro, que prometan lo que la app no hace, ni que graben donde está
  prohibido.

## 5. Cómo se mide

Igual que todo lo demás: **la base de datos es la tabla de resultados**, y cada creador
entra en ella como un origen propio.

- **Antes del lanzamiento (lista de espera)**:
  `https://travelsnomad.com/?utm_source=instagram&utm_medium=influencer&utm_campaign=<usuario>`
...
- **La decisión, en aritmética**: el coste por alta (o por compra) de cada creador,
  ...
  creador que trae cero no repite. Y un creador que no ha traído nada **no se juzga por su
