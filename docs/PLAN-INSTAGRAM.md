...
repo. Por eso repite cosas que en el repo viven en `docs/INSTAGRAM-ARRANQUE.md` y
`docs/LANZAMIENTO-PUBLICIDAD.md` — **si algún día divergen, mandan esos dos**.
...
| 4 | El precio — Place du Tertre de noche | El viaje entero, por lo que cuesta el café de la plaza: desde 2,99 €. Sin suscripción. Se paga por viaje. |
