...
ESCENAS['reelit-01'] = (RAIZ
  ...
  + sub('Ecco cosa mi ha scritto. 👇', 900, 44)
  + marca()
  + '</div>')
...
ESCENAS['reelit-02'] = (RAIZ
  ...
  + titular('Cosa vedere, in che ordine<br>e quanto costa.', 320, 58, 920)
...
ESCENAS['reelit-04'] = (RAIZ
  ...
  + titular('Inquadri un&rsquo;opera<br>e ti racconta la sua storia.', 320, 58, 920)
...
print('escritas', len(ESCENAS), 'escenas IT')
