...
# móvil con el plan real y «Tu primer viaje, por 1,99 €», con el precio como es: dure lo
...
html = (f'<div style="width: {W}px; height: {H}px; position: relative; overflow: hidden; background: #100E0B; color: {PAPEL}">'
        ...
        + telefono('plan-900.webp', 300, 70).replace('left: 50%; top: 70px; transform: translateX(-50%)', 'left: 130px; top: 70px')
        + '</div></div>')
