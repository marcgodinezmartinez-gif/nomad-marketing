...
T = {
  'es': {
    ...
    'qe-6': ('Y cu&aacute;nto cuesta', 'El viaje entero,<br>desde 2,99&nbsp;&euro;.',
    ...
    'li-2': ('Lo que te llevas', 'Tu primer viaje,<br>por 1,99&nbsp;&euro;.',
             'Dure lo que dure. S&oacute;lo para quien<br>est&eacute; en la lista el d&iacute;a que abramos.'),
  ...
  'it': {
    ...
    'qe-6': ('E quanto costa', 'Il viaggio intero,<br>da 2,99&nbsp;&euro;.',
    ...
    'li-2': ('Cosa ti porti a casa', 'Il primo viaggio,<br>a 1,99&nbsp;&euro;.',
             'Qualunque sia la durata. Solo per chi &egrave;<br>in lista il giorno in cui apriamo.'),
