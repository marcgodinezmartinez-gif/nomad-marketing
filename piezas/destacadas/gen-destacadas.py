...
T = {
  'es': {
    ...
    'qe-3': ('2 &middot; El tour a pie', 'Una voz te lleva<br>de parada en parada.'),
    'qe-4': ('3 &middot; El museo', 'Enfocas un cuadro<br>y te cuenta su historia.'),
  ...
  'it': {
    ...
    'qe-3': ('2 &middot; Il tour a piedi', 'Una voce ti porta<br>di tappa in tappa.'),
    'qe-4': ('3 &middot; Il museo', 'Inquadri un quadro<br>e ti racconta la sua storia.'),
